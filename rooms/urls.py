...
from .views import ManageFavoriteRoomsView, RoomListCreateView, RoomRetrieveUpdateDestroyView, ManageRoomBedsView, BedListCreateView, BedTypeListView, BedDetailView
